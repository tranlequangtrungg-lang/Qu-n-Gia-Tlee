        ...
        if (!deferred) return;
            ...
            if (success) {
                ...
                const successMessages = [
                    `A kind stranger drops **${formatCurrency(amountWon)}** into your cup.`,
                    `You spotted an unattended wallet! You grab **${formatCurrency(amountWon)}** and run.`,
                    `Someone took pity on you and gave you **${formatCurrency(amountWon)}**!`,
                    `You found **${formatCurrency(amountWon)}** under a park bench.`,
                ];
